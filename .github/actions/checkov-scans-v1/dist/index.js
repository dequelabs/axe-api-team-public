...
/*! checkov-scans-v1 v1.0.0 | MPL-2.0 */
  ...
  "../../../../../../../Users/jonathangarbee/Developer/axe-api-team-public/node_modules/pnpm-lock-to-npm-lock/lib/createLock.js"(exports) {
    ...
    function createLock(pnpmLock) {
      ...
      Object.entries(pnpmLockObject.packages).forEach(function(_a) {
        ...
        var pkgDepObj = __assign(__assign({}, baseDepObj), { requires, dependencies });
...
var require_start = __commonJS({
  "../../../../../../../Users/jonathangarbee/Developer/axe-api-team-public/node_modules/pnpm-lock-to-npm-lock/lib/start.js"(exports, module) {
    ...
    var createLock_1 = require_createLock();
    ...
    (0, helpers_1.printPrettyLine)();
    function handleConversion2(_a) {
      var ctx = _a.ctx, pnpmPath2 = _a.pnpmPath;
      if (ctx === constants_1.runtimeContext.RUSH) {
        reportStats(handleConversionRUSH());
      } else {
        reportStats(handleConversionWithPath(pnpmPath2));
      }
    }
    ...
    module.exports = handleConversion2;
  }
});

// src/index.ts
var import_start = __toESM(require_start(), 1);
...
(0, import_start.default)({ pnpmPath });
