import{createRequire as _cr}from'node:module';import{fileURLToPath as _f}from'node:url';const require=_cr(import.meta.url);const __filename=_f(import.meta.url);const __dirname=_f(new URL('.',import.meta.url));
