...
// src/readFile.ts
function readOptionalFileSync(path6, encoding, readFileSync2) {
  try {
    return readFileSync2(path6, encoding);
  } catch (err) {
    if (err.code === "ENOENT") {
      return null;
    }
...
// src/run.ts
function run(core, readFileSync2) {
  try {
